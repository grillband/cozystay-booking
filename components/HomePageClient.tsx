...
export function HomePageClient({ initialRooms, error: initialError }: { initialRooms: Room[], error: string | null }) {
  const [rooms, setRooms] = useState<Room[]>(initialRooms);
  const [selectedRoomId, setSelectedRoomId] = useState<string | undefined>(initialRooms.length > 0 ? initialRooms[0].id : undefined);
